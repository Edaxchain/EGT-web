...
export default function Benefit() {
    return (
        <section className="py-20 bg-brand-dominant/5 rounded-[3rem] my-20">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-surface p-8 rounded-[2rem] shadow-sm border border-brand-dominant/10">
                        ...
                        <h4 className="font-bold text-xl mb-4">Smart Innovation</h4>
                    ...
                    <div className="bg-surface p-8 rounded-[2rem] shadow-sm border border-brand-dominant/10">
                        ...
                        <h4 className="font-bold text-xl mb-4">Exclusive Discount</h4>
                        <ul className="space-y-3 text-sm text-text-main">
                    ...
                    <div className="bg-surface p-8 rounded-[2rem] shadow-sm border border-brand-dominant/10">
                        ...
                        <h4 className="font-bold text-xl mb-4">Financial Freedom</h4>
                        <ul className="space-y-3 text-sm text-text-main">
