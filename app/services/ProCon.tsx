    ...
    const pros = [
        {
            ...
            text: "ผลิตไฟฟ้าได้ทุกขนาด ทั้งในบ้าน การเกษตร หรือโรงงานอุตสาหกรรม",
        },
        {
            icon: <Sun className="w-5 h-5" />,
            text: "พลังงานที่ไม่จำกัด ผลิตไฟฟ้าจากแสงอาทิตย์ได้ตลอดไป",
        },
        {
            icon: <Zap className="text-brand-dominant w-5 h-5" />,
            text: "ช่วยลดค่าไฟฟ้าได้มากถึง 60 - 90% (ขึ้นอยู่กับการออกแบบ)",
        },
        {
            icon: <Leaf className="w-5 h-5" />,
            text: "พลังงานสะอาดที่เป็นมิตรต่อสิ่งแวดล้อม",
        },
        {
            icon: <ShieldCheck className="w-5 h-5" />,
            text: "ปลอดภัย ไม่มีมลพิษที่ส่งผลเสียต่อสุขภาพ",
        },
    ];
    ...
    const cons = [
        {
            ...
            text: "ปริมาณการผลิตขึ้นอยู่กับแสงอาทิตย์ในแต่ละวัน",
        },
        {
            icon: <BatteryCharging className="w-5 h-5" />,
            text: "พลังงานขึ้นอยู่กับจำนวนแผงที่ติดตั้ง",
        },
        {
            icon: <HelpCircle className="w-5 h-5" />,
            text: "ควรศึกษาและคำนวณก่อนติดตั้ง เพื่อความคุ้มค่าสูงสุด",
        },
        {
            icon: <AlertCircle className="w-5 h-5" />,
            text: "ไม่สามารถใช้พลังงานโซล่าเซลล์ได้โดยตรงในตอนกลางคืน",
        },
        {
            icon: <BatteryCharging className="w-5 h-5" />,
            text: "หากต้องการใช้ตอนกลางคืน ต้องมีอุปกรณ์แบตเตอรี่เพิ่มเติม",
        },
    ];
        ...
        <section className="py-12 bg-background overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-text-sub font-light">
                        ข้อมูลจริงเพื่อประกอบการตัดสินใจก่อนการลงทุน
                    </p>
                </motion.div>
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-8 md:justify-end">
                            <h3 className="text-2xl font-bold text-brand-strong uppercase tracking-wider">
                                ข้อดี
                            </h3>
                        ...
                        <div className="space-y-6">
                            {pros.map((item, idx) => (
                                ...
                                >
                                    <div className="shrink-0 w-10 h-10 rounded-xl bg-brand-dominant/10 flex items-center justify-center text-brand-dominant transition-colors group-hover:bg-brand-dominant group-hover:text-background-static">
                                        {item.icon}
                                    </div>
                    ...
                    >
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h3 className="text-2xl font-bold text-text-sub uppercase tracking-wider">
                                ข้อควรพิจารณา
                            </h3>
                        </div>
