...
export default function Hero() {
    ...
    const results = useMemo(() => {
        ...
        return {
            ...
            saving: (dayUnits * 4.7).toLocaleString(undefined, {
    ...
    return (
        <section
            id="hero"
            className="relative min-h-screen py-24 px-8 md:px-12 lg:px-48 bg-brand-subtle overflow-hidden"
        >
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-dominant/10 rounded-full text-brand-dominant font-bold text-sm">
                        ...
                        ประสบการณ์ธุรกิจไฟฟ้ากว่า 10 ปี
                    </div>
                    ...
                    <p className="text-lg text-text-sub max-w-md leading-relaxed">
                        ...
                        ที่ช่วยให้คุณคุ้มค่ามากกว่าแค่การประหยัดไฟ
                    </p>

                    <div className="flex flex-wrap gap-4 text-sm font-medium">
                        <span className="text-brand-dominant">
                            • อุปกรณ์ผ่านมาตรฐาน
                        </span>
                        <span className="text-brand-dominant">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                />
                                <span className="absolute right-6 top-1/2 -translate-y-1/2 font-bold text-text-main">
                                    THB
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between text-sm font-bold text-text-main">
                                ...
                                <p className="text-brand-dominant">
                                    {dayUsage[0]}%
                                </p>
                            </div>
                            <Slider
                        ...
                        <div className="bg-brand-dominant/5 rounded-[2.5rem] p-6 grid grid-cols-2 gap-4 border border-brand-dominant/10">
                            <div className="space-y-1">
                                <p className="text-xl uppercase font-bold text-text-main tracking-wider">
                                    ระบบที่แนะนำ
                                </p>
                                <p className="text-xl font-black text-brand-strong">
                                    {results.kw}{" "}
                            ...
                            <div className="space-y-1 border-t border-brand-dominant/10 pt-3">
                                <p className="text-lg uppercase font-bold text-text-main tracking-wider">
                                    จำนวนแผง
                                </p>
                                <p className="text-lg font-bold text-brand-strong">
                                    {results.panels}{" "}
                                    <span className="text-xs font-normal">
                                        แผง
                                    </span>
