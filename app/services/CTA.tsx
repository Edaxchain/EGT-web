            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
                ...
                <div className="text-center md:text-left flex-1">
                    ...
                    <p className="text-text-main font-brand max-w-xl leading-relaxed">
                        ...
                        <br />
                        <span>ติดตั้งวันนี้... รับสิทธิ์สำรวจหน้างานและออกแบบฟรี!</span><br />
                        <span>✔ ฟรี! ออกแบบ 2D/3D</span><br />
                        <span>✔ ฟรี! บริการขออนุญาตขนานไฟ</span><br />
                        <span>✔ ฟรี! วิศวกรเซ็นรับรองแบบ</span><br />
                    </p>
                </div>
